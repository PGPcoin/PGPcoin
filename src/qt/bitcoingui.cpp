    ...
    nWeight(0)
{
    ...
    if (!fUseBlackTheme)
    {
        ...
        {
            progressBar->setStyleSheet("QProgressBar { color: #2DF8FB;  background: transparent; border: 1px solid red; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: transparent; margin: 0px; }");
        }
    }
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: red; font-weight:bold;} QToolButton:hover { background-color: transparent } QToolButton:checked { background-color: transparent } QToolButton:pressed { background-color: transparent } #tabs { color: red; background-color: transparent;  }");
